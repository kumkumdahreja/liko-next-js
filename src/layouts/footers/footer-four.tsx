              ...
              <div className="tp-footer-3-widget-wrapper footer-col-3-1">
                <div className="tp-footer-3-widget mb-40">
                  ...
                  <div className="tp-footer-3-menu">
                    <ul>
                        <li><Link href="/home-11">Home</Link></li>
                        <li><Link href="/src/pages/about/about-us.tsx">About Us</Link></li>
                        <li><Link href="/src/pages/service/service.tsx">Services</Link></li>
                        <li><Link href="/src/pages/portfolio/portfolio-grid-col-4-fullwidth-main.tsx">Portfolio</Link></li>
                        <li><Link href="/src/pages/team/team.tsx">Our Team</Link></li>
                        <li><Link href="/src/pages/contact/contact.tsx">Contact</Link></li>
                        <li><Link href="/src/pages/blog/blog-list.tsx">Blog</Link></li>
                      </ul>
                  </div>
                </div>
                ...
                <div className="tp-footer-3-widget mb-30">
                  ...
                  <div className="tp-footer-2-contact-item">
                    <span>
                      ...
                      target="_blank">Office No. LG007, H-36, Green Leafers Business Park, Sector-63, Noida</Link>
                      </span>
                  </div>
                  <div className="tp-footer-2-contact-item">
                    <span>P: <Link href="tel:+91-7300764266">+91-7300764266</Link></span>
                    <span>E: <Link href="mailto:contact@thebrandingstudio.in">contact@thebrandingstudio.in</Link></span>
                  </div>
                </div>
                <div className="tp-footer-3-widget">
